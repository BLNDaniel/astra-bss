--[[
  UI lib OFFICIALLY made by bungie#0001
]]
...
local library = {
    version = "2.0.2",
    title = title or "Astra " .. tostring(math.random(1,366)),
    fps = 0,
    rank = "private"
}
...
function library:Introduction()
    ...
    local barCorner = Instance.new("UICorner")
    local barLayout = Instance.new("UIListLayout")
    local astraLogo = Instance.new("ImageLabel")
    ...
    astraLogo.Parent = background
    astraLogo.AnchorPoint = Vector2.new(0.5, 0.5)
    astraLogo.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    astraLogo.BackgroundTransparency = 1.000
    astraLogo.Position = UDim2.new(0.5, 0, 0.5, 0)
    astraLogo.Size = UDim2.new(0, 448, 0, 150)
    astraLogo.Visible = true
    astraLogo.Image = "http://www.roblox.com/asset/?id=9365068051"
    astraLogo.ImageColor3 = Color3.fromRGB(159, 115, 255)
    astraLogo.ImageTransparency = 1
    ...
    astra.Name = "astra"
    astra.Parent = background
    astra.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    astra.BackgroundTransparency = 1.000
    astra.Size = UDim2.new(0, 80, 0, 21)
    astra.Font = Enum.Font.Code
    astra.Text = "powered by astra"
    astra.TextColor3 = Color3.fromRGB(124, 124, 124)
    astra.TextSize = 10.000
    astra.TextTransparency = 1
    ...
    CreateTween("astraRotation", 0)
    local MinusAmount = -16
    coroutine.wrap(function()
        while wait() do
            MinusAmount = MinusAmount + 0.4
            TweenService:Create(astraLogo, TweenTable["astraRotation"], {Rotation = astraLogo.Rotation - MinusAmount}):Play()
        end
    end)()
    ...
    wait(.2)
    TweenService:Create(astra, TweenTable["introduction"], {TextTransparency = 0}):Play()
    TweenService:Create(text, TweenTable["introduction"], {TextTransparency = 0}):Play()
    wait(.3)
    TweenService:Create(astraLogo, TweenTable["introduction"], {ImageTransparency = 0}):Play()
    wait(2)
    TweenService:Create(astraLogo, TweenTable["introduction"], {ImageTransparency = 1}):Play()
    wait(.2)
    ...
    wait(.1)
    TweenService:Create(astra, TweenTable["introduction"], {TextTransparency = 1}):Play()
    wait(.1)
